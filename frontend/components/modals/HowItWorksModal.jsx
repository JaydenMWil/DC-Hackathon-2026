      ...
      <TouchableOpacity style={s.overlay} activeOpacity={1} onPress={onClose}>
        <View style={[s.modalBox, { maxHeight: '90%', paddingBottom: 10 }]}>
          <TouchableOpacity activeOpacity={1}>
            <Text style={[s.modalTitle, { marginBottom: 4 }]} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>How AccessRide Works</Text>
            <Text style={[s.mutedSm, { marginBottom: 16, textAlign: 'center' }]}>An inclusive, gamified transit companion</Text>
            ...
            <TouchableOpacity style={[s.btnGreen, { marginTop: 16 }]} onPress={onClose}>
              <Text style={s.btnText} adjustsFontSizeToFit numberOfLines={1} minimumFontScale={0.7}>Got it!</Text>
            </TouchableOpacity>
          </TouchableOpacity>
        </View>
      </TouchableOpacity>
